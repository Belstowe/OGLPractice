...
public:
  ...
  ObjPyramid(GLuint program, glm::vec3 pos, PNGTexture *baseTexture,
             PNGTexture *overlayTextureFront, PNGTexture *overlayTextureBack,
...
private:
  ...
  GLfloat frontVerticles[30] = {
      ...
      0.5f,  0.0f,  0.0f,  0.5f, 0.0f, 0.5f,  1.0f,

      -0.5f, -0.5f, 0.5f,  0.5f, 0.0f, 0.5f,  -0.5f, 0.5f,
      0.0f,  0.0f,  0.0f,  0.5f, 0.0f, 0.5f,  1.0f};
