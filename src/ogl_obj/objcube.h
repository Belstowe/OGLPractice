...
private:
  ...
  GLfloat topVerticles[30] = {
      ...
      0.5f,  0.5f, -0.5f, 1.0f, 1.0f,  0.5f, 0.5f,  0.5f, 1.0f,
      0.0f,  0.5f, 0.5f,  0.5f, 1.0f,  0.0f, -0.5f, 0.5f, 0.5f,
  ...
  GLfloat sideVerticles[120] = {
      ...
      0.0f,  -0.5f, -0.5f, -0.5f, 0.0f,  0.0f,  -0.5f, -0.5f, 0.5f,
