...
int main()
{
    ...
    GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Container, now in 3D!", NULL, NULL);
    if (window == NULL) {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        model = glm::rotate(model, glm::radians(timeValue * 90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
